...
function TableSale({
  ...
  useEffect(() => {
    /* Si se han agregado items del buscador a la tabla de platillos */
  ...
  return (
    <div className="comanda-digital">
      ...
      <div className="resumen-comanda">
        <Table className="table responsive table-resumen" responsive>
          <thead>
            <tr>
          ...
          <tbody className="table-resumen-body">
            ...
            <tr className="row-resumen">
              <td className="table-summary-item">Tipo: 1</td>
            </tr>
            <tr className="row-resumen">
