...
function ModalBox(props) {
  /* ------------------------------------
  ***************************************
  NOTA: este componente pasó a una implementación directa en la page llamada "CashBox", por que en la lógica hay un renderizado condicional en el que estaba involucrado este componente.
  -Las actualización del estado a través de props en un renderizado condicional era el problema.
  ------------------------------------
  ***************************************
   */
